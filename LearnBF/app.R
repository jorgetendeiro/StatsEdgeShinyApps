    ...
    tabPanel("Bayesian t-test", 
             ...
             sidebarLayout(
               ...
               mainPanel(
                 ...
                 paste0("Cconditional on the two specific models being tested ($\\mathcal{H}_0$ and $\\mathcal{H}_1$), below is a breakdown of how the prior probabilities, the Bayes factor, and the posterior probabilities relate to each other:"), 
                 tableOutput("BF.df2"),
                 br(), br(),
